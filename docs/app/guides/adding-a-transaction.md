...
![The New Transaction modal on a loan](/img/docs/app/guides/adding-a-transaction/new-transaction-modal.png)
...
![The transaction type dropdown listing the available types](/img/docs/app/guides/adding-a-transaction/transaction-types.png)
