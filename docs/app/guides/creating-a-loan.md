...
Whenever the [loan type](#step1-type) is a tract of land, the tract must be selected. It will drop down a list of the developments and the tracts in each development. For a tract to be selectable it must be available and no other active loan can be against the tract of land.
...
### Down Payment {#step2-downpayment}
...
### Amount Financed {#step2-amt-financed}
...
### Extra Payment Application {#step2-extra-application}
...
### First Payment Date {#step3-first-payment-date}
...
### Days Until Date {#step3-grace-period}
...
### Late Fee Application {#step3-late-fee-application}
...
### Max Late Fee {#step3-max-late-fee}
...
### Step 3 Screenshot
![img](../../../static/img/docs/app/guides/creating-a-loan/third-step.png)
...
## Step 5: Review {#step5}
The fifth, and final, step is to review all of the data which you have entered before saving it. The review also includes an amoritzation schedule. Once you have reviewed all of the data and double checked it is correct, click the **Save** button and you are done creating the loan!
