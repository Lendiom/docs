...
![The escrow inputs shown while creating a loan](/img/docs/app/how-it-works/loan-escrow/escrow-inputs.png)
...
![The escrow details card on a loan](/img/docs/app/how-it-works/loan-escrow/escrow-details.png)
...
![Recording a new escrow transaction on a loan](/img/docs/app/how-it-works/loan-escrow/new-escrow-transaction.png)
...
![The modal for updating a loan's escrow amount](/img/docs/app/how-it-works/loan-escrow/update-escrow.png)
